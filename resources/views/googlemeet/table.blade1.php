        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    {{-- <div >
                        <a class="btn btn-primary panel active UpcomingMeeting" id="tabId-1"
                            onclick="onFormPanel('UpcomingMeeting')"><i class="fa fa-exchange join">
                                Upcoming Meeting
                            </a>
                    </div> --}}
                    ...
                    <div class="card-body tabs-area p-0">
                        {{-- <ul class="tabs-nav">
                            <li>
                                <a class="panel active UpcomingMeeting" id="tabId-1"
                                    onclick="onFormPanel('UpcomingMeeting')"><i class="fa fa-exchange join"></i>Upcoming
                                    Meeting</a>
                            </li>
                            <li><a class="panel PreviousMeeting" id="tabId-2"
                                    onclick="onFormPanelform('PreviousMeeting')"><i class="fa fa-exchange join"></i>Previous
                                    Meeting</a></li>
                            <li><a class="panel LiveMeeting" id="tabId-3" onclick="onFormPanelform('LiveMeeting')"><i
                                        class="fa fa-exchange join"></i>Live Meeting</a></li>
                            <li><a class="panel setting" id="tabId-4" onclick="onFormPanelform('setting')"><i
                                        class="fa fa-cog join"></i>Zoom Settings</a></li>
                        </ul> --}}
                        ...
                        <div class="row" style="margin-left:20px">
                            ...
                            {{-- <div class="float-right mb-2" style="text-align:right; margin-right:12px;">
                                <a onclick="newmeet()" id="newmeet" class="btn join fl-right"><i
                                        class="fa fa-plus"></i> New Meeting</a>
                                <a onclick="onFormPanel('back')" id="back" href="javascript:void(0);"
                                    class="btn btn-warning btn-list fl-right d-none"><i class="fa fa-plus"></i> Back to
                                    List</a>
                            </div> --}}
                        ...
                        <div class="row1 my-3" style="margin-left:30px">
                            {{-- <div class="col-md-3"> --}}
                            ...
                            {{-- </div> --}}
                            {{-- <div class="col-md-3"> --}}
                            {{-- <a class="btn join  panel setting" id="tabId-4" style="color:#fff"
                                onclick="onFormPanelform('setting')">
                                Settings
                            </a> --}}
                            {{-- </div> --}}
                        </div>
                    ...
                    if ((data.user_data) != '') {
                        $.each(data.user_data, function(key, val) {
                            ...
                            if (val.profile_pic != '' && val.profile_pic != null) {
                                var image =
                                    `{{ asset('public/assets/profile_pic/${val.profile_pic}') }}`;
                            } else {
                ...
                success: function(data) {
                    ...
                    if (data.data != '') {
                        ...
                        if (val.profile_pic != '' || val.profile_pic != null) {
                            ...
                            var image = `{{ asset('public/assets/profile_pic/no_image_available.png') }}`;
                        }
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        var routeUrl = "{{ route('googleMeetDelmembers') }}";
