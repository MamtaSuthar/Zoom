<meta name="keywords" content="creative tim, updivision, html dashboard, laravel, html css dashboard laravel, {{env('APP_NAME')}}, laravel soft ui dashboard, soft ui admin, laravel dashboard, laravel admin, web dashboard, bootstrap 5 dashboard laravel, bootstrap 5, css3 dashboard, bootstrap 5 admin laravel, soft ui dashboard bootstrap 5 laravel, frontend, responsive bootstrap 5 dashboard, soft ui dashboard, soft ui laravel bootstrap 5 dashboard" />
<meta name="description" content="A free Laravel Dashboard featuring dozens of UI components & basic Laravel CRUDs." />
<meta itemprop="name" content="{{env('APP_NAME')}} by Creative Tim & UPDIVISION" />
...
<meta name="twitter:title" content="{{env('APP_NAME')}} by Creative Tim & UPDIVISION" />
...
<meta property="og:title" content="{{env('APP_NAME')}} by Creative Tim & UPDIVISION" />
