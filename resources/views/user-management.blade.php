            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="{{url('staff/create')}}" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New User</a>
                    </div>
                </div>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <span>
                                            <form action="{{route('staff.destroy', $user->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button class="btn" onclick="return confirm('Are you want to delete this?')"><i  class="cursor-pointer fas fa-trash text-secondary" onclick="return confirm('Are you want to delete this?')"></i></button>
                                            </form>
