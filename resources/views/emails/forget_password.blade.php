   ...
   <body style="background-color:#ffffff; font-family: 'Roboto', sans-serif;">
      <div style="width:575px; margin:30px auto;padding:0px 25px; background-color:#f9f9f9; border-top:4px solid #e40303">
         ...
         <div style="padding:0px 0px 40px; display: inline-block;">
            <div>
               <img src="{{asset('public/assets/img/banner-all.png')}}" alt="img" width="100%" style=""/>
            </div>
            <div style="background-color:#fff;padding: 0px 20px 10px; overflow: hidden;">
               ...
               <p style="text-align:left; font-size:16px; font-weight:400; color:#353535; padding-top:30px; margin-bottom:10px;margin-top: 0px;">We received a request to reset your password for your account at {{(env('APP_NAME'))}}. To proceed with the password reset, please click on the button below:</p>
               ...
               <div style="text-align:center; padding-bottom:20px; padding-top:20px;"> 				   
                <a href="{{route('password.reset',$details->token)}}" style="text-decoration:none;">
                    <span style="padding:8px 30px; border-radius:2px; color:#ffffff; font-size:17px; background-color:#e40303; text-align:center; font-weight:600">Choose A New Password</span>
                </a>  
            </div>
            <p style="text-align:left; font-size:16px; font-weight:400; color:#353535; padding-top:30px; margin-bottom:5px;margin-top: 0px;">Please note that the password reset link is valid for a limited time. If the link expires, you can initiate a new password reset request through our website.</p>
            <p style="text-align:left; font-size:16px; font-weight:400; color:#353535; padding-top:30px; margin-bottom:10px;margin-top: 0px;">If you encounter any difficulties or need further assistance, please contact our support team at [Support Contact Information]. We are here to help you.</p>
